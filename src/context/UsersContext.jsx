...
const UsersContext = ({ children }) => {
  ...
  const getUsers = async () => {
    try {
      ...
      const response = await axios.get(
        "https://rollingmarketback.onrender.com/api/user/"
        , {
          headers: {
            authorization: `${token}`,
          }
  ...
  const addUser = async (usuario) => {
    try {
      ...
      const response = await axios.post("https://rollingmarketback.onrender.com/api/user/create", usuario, {
        headers: {
          authorization: `${token}`,
        },
      });
  ...
  const deleteUsuario = async (id) => {
    try {
      ...
      if (confirmacion.isConfirmed) {
        await axios.delete(`https://rollingmarketback.onrender.com/api/user/delete/${id}`, {
          headers: {
            authorization: `${token}`,
          }
        });
  ...
  const editUsuario = async (usuario) => {
    ...
    try {
      await axios.put(
        `https://rollingmarketback.onrender.com/api/user/update/${usuario.id}`,
        usuario,
        {
          headers: {
            authorization: `${token}`,
  ...
  const loginUsuario = async (usuario) => {
    try {
      const response = await axios.post(
        "https://rollingmarketback.onrender.com/api/user/login",
        usuario
      );
